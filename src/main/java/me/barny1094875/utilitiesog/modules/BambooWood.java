...
public class BambooWood {
    ...
    public static void Enable() {
        ...
        bambooWoodMeta.displayName(UtilitiesOG.getMM().deserialize("Bamboo Wood").decoration(TextDecoration.ITALIC, false));
        bambooWood.setItemMeta(bambooWoodMeta);
        ShapedRecipe BambooWood = new ShapedRecipe(new NamespacedKey(UtilitiesOG.getPlugin(), "Bamboo_Wood"),
                bambooWood)
                .shape("bb", "bb")
