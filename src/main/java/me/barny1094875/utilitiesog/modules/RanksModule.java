...
public class RanksModule implements CommandExecutor {
        ...
        if (sender instanceof Player) {
            if (player.hasPermission("utilities.ranks")) {
                ...
                if (args.length == 0) {
                    ...
                    player.sendMessage(UtilitiesOG.getMM().deserialize("<bold><dark_purple>-=-=-=-=- <dark_green>True<dark_red>OG <aqua>Donation Store: <dark_purple>-=-=-=-=-"));
                    player.sendMessage("");
                    player.sendMessage("Each donor rank requires the rank before it.");
                    player.sendMessage("");
                    player.sendMessage(UtilitiesOG.getMM().deserialize("<green>Rank Overview: <dark_aqua><underlined>https://shop.true-og.net"));
                    player.sendMessage("");
                    player.sendMessage(UtilitiesOG.getMM().deserialize("<white>[OG] <gray>(<dark_green>$10 Once<gray>) <dark_aqua><underlined>https://true-og.net/og"));
                    sendClickableMessage(player, "/ranks og");
                    player.sendMessage("");
                    player.sendMessage(UtilitiesOG.getMM().deserialize("<red>[OG Pro] <gray>(<dark_green>$50 Once<gray>) <dark_aqua><underlined>https://true-og.net/og-pro"));
                    sendClickableMessage(player, "/ranks og-pro");
                    player.sendMessage("");
                    player.sendMessage(UtilitiesOG.getMM().deserialize("<dark_red><bold>[OG Master] <gray>(<gold>$10 Monthly<gray>) <dark_aqua><underlined>https://true-og.net/og-master"));
                ...
                // If the player provided one or more arguments, do this...
                    ...
                    if (args[0].equalsIgnoreCase("og")) {
                        ...
                        player.sendMessage(UtilitiesOG.getMM().deserialize("<dark_purple><bold>-=-=-=-=- <dark_green>True<dark_red>OG <white>OG Rank: <dark_purple>-=-=-=-=-"));
                    ...
                    // If the OG Pro text was clicked, do this...
                        ...
                        player.sendMessage(UtilitiesOG.getMM().deserialize("<dark_purple><bold>-=-=-=-=- <dark_green>True&<dark_red>OG <red>OG Pro Rank: <dark_purple>-=-=-=-=-"));
                    ...
                    // If the OG Master text was clicked, do this...
                        ...
                        player.sendMessage(UtilitiesOG.getMM().deserialize("<dark_purple><bold>-=-=-=-=- <dark_green>True<dark_red>OG <dark_red>OG Master Rank: <dark_purple>-=-=-=-=-"));
                    ...
                    player.sendMessage(UtilitiesOG.getMM().deserialize("<gray>[<dark_green>True<dark_red>OG<gray>] <red>ERROR: Too many arguments! <gold>Syntax: <yellow>/ranks"));
    ...
    public static void sendClickableMessage(Player player, String command) {
        ...
        TextComponent clickableText = (TextComponent) UtilitiesOG.getMM().deserialize("<aqua><bold>Click here to see the benefits!");
